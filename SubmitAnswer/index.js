    ...
    if (STAGES.indexOf(stage) >= 0) {
        loadConfig(config_table, stage, context, function(env_config){
            ...
            if (question_text === undefined || question_text === null || question_text === '') {
                var error = new Error("Question text missing");
                return callback(error);
            }
...
// function updateAsker(info, callback) {
//     console.log(info);
//     //get first and then update 
//     var params = {
//         TableName : user_table,
//         IndexName : "user_id_index",
//         KeyConditionExpression : "user_id = :user_id",
//         ExpressionAttributeValues : {
//             ":user_id" : info.asker_user_id
//         }
//     };
...
//                     TableName : user_table,
//                     Key : {
//                         'google_id' : data['Items'][0].google_id
//                     },
...
//                 docClient.update(params2, function(err) {
//                     if (err) {
//                         callback(err);
//                     } else {
//                         callback(null, info);
...
function updateAnswerer(info, callback) {
    //price - info.answerer.price balance = info.answerer_details.balance 
    //add answer to the details
    //update pending questions count
    //add balance 
    //enable account if its disabeled 
